...
import { ElemType, HtmlA, HtmlB, HtmlDiv } from '../index.js'
...
test('test #1', t => {
  ...
  t.is(elem.toString(), '<div id="root"><div id="id1" hidden=""><a><div><b>wow</b></div></a></div></div>')
  ...
  t.is(b.closest(HtmlDiv, ['id', 'id1']), div1)
  t.is(b.closest(ElemType, elem => elem.id === 'root'), elem)
  t.is(b.closest(ElemType, ['id', 'root']), elem)
  t.is(b.closest(ElemType, 'hidden'), div1)
  ...
  t.is(div2.closest(HtmlDiv, ['id', 'id1']), div1)
  t.is(div2.closest(ElemType, elem => elem.id === 'root'), elem)
  t.is(div2.closest(ElemType, ['id', 'root']), elem)
  t.is(div2.closest(ElemType, 'hidden'), div1)
  ...
  t.is(a.closest(HtmlDiv, ['id', 'id1']), div1)
  t.is(a.closest(ElemType, elem => elem.id === 'root'), elem)
  t.is(a.closest(ElemType, ['id', 'root']), elem)
  t.is(a.closest(ElemType, 'hidden'), div1)
  ...
  t.is(div1.closest(HtmlDiv, ['id', 'id1']), div1)
  t.is(div1.closest(ElemType, elem => elem.id === 'root'), elem)
  t.is(div1.closest(ElemType, ['id', 'root']), elem)
  t.is(div1.closest(ElemType, 'hidden'), div1)
  ...
  t.is(elem.closest(HtmlDiv, ['id', 'id1']), null)
  t.is(elem.closest(ElemType, elem => elem.id === 'root'), elem)
  t.is(elem.closest(ElemType, ['id', 'root']), elem)
  t.is(elem.closest(ElemType, 'hidden'), null)
})
