...
var _dommodule = __webpack_require__(17);
...
var _window = window,
    ...
    HTMLButtonElement = _window.HTMLButtonElement,
    HTMLElement = _window.HTMLElement,
    HTMLHtmlElement = _window.HTMLHtmlElement,
    HTMLSpanElement = _window.HTMLSpanElement,
    Text = _window.Text,
    document = _window.document;


var assembler = new _element.HTMLElementAssembler();

describe('HTMLElementAssembler', function () {
    describe('new HTMLElementAssembler', function () {
        var test = new _element.HTMLElementAssembler();
        var node = test.node;
        it('node', function () {
            assert.instanceOf(node, HTMLElement);
        });
        it('node.constructor', function () {
            assert.equal(node.constructor, HTMLHtmlElement);
        });
        it('node.tagName', function () {
            assert.equal(node.tagName, 'HTML');
        });
        it('node.hasAttributes()', function () {
            assert.isFalse(node.hasAttributes());
        });
        it('node.outerHTML', function () {
            assert.equal(node.outerHTML, '<html></html>');
        });
    });
    describe('init', function () {
        var test = new _element.HTMLElementAssembler({ localName: 'a' });
        var node = test.node;
        test.init({
        ...
        describe('assembler interfaces', function () {
            it('attrset', function () {
    ...
    describe('attributes', function () {
        var node = assembler.assemble({ localName: 'input' });
        assembler.attrset = {
            checked: '',
            disabled: '',
    ...
    describe('style', function () {
        var node = assembler.assemble({ localName: 'span' });
        assembler.style = {
            color: 'white',
    ...
    describe('children', function () {
        var child = new _element.HTMLElementAssembler();
        child.assemble({ localName: 'span' });
        var node = assembler.assemble({ localName: 'div' });
        assembler.children = [0, // ignored
        document.createElement('button'), '', // ignored
        'text node as string', NaN, // ignored
        document.createTextNode('created text node'), null, // ignored
        document.createElement('a'), false, // ignored
        document.createComment('Simple DOM Comment node'), undefined, // ignored
        child];
        var childNodes = node.childNodes;
        it('has ' + childNodes.length + ' child nodes', function () {
            assert(node.hasChildNodes(), 'has child nodes');
            assert.equal(childNodes.length, 6);
        });
        it('1: button', function () {
            assert.equal(childNodes[0].constructor, HTMLButtonElement);
            assert.equal(childNodes[0].tagName, 'BUTTON');
        });
        it('2: text node as string', function () {
            assert.equal(childNodes[1].constructor, Text);
            assert.equal(childNodes[1].textContent, 'text node as string');
        });
        it('3: created text node', function () {
...
var _window = window,
    ...
    HTMLElement = _window.HTMLElement,
    HTMLAnchorElement = _window.HTMLAnchorElement,
    HTMLAreaElement = _window.HTMLAreaElement,
    HTMLAudioElement = _window.HTMLAudioElement,
    HTMLBaseElement = _window.HTMLBaseElement,
    HTMLBlockElement = _window.HTMLBlockElement,
    HTMLBodyElement = _window.HTMLBodyElement,
    HTMLButtonElement = _window.HTMLButtonElement,
    HTMLBRElement = _window.HTMLBRElement,
    HTMLCanvasElement = _window.HTMLCanvasElement,
    HTMLDataListElement = _window.HTMLDataListElement,
    HTMLDivElement = _window.HTMLDivElement,
    HTMLDListElement = _window.HTMLDListElement,
    HTMLEmbedElement = _window.HTMLEmbedElement,
    HTMLFieldSetElement = _window.HTMLFieldSetElement,
    HTMLFormElement = _window.HTMLFormElement,
    HTMLHeadingElement = _window.HTMLHeadingElement,
    HTMLHeadElement = _window.HTMLHeadElement,
    HTMLHRElement = _window.HTMLHRElement,
    HTMLHtmlElement = _window.HTMLHtmlElement,
    HTMLIFrameElement = _window.HTMLIFrameElement,
    HTMLImageElement = _window.HTMLImageElement,
    HTMLInputElement = _window.HTMLInputElement,
    HTMLLabelElement = _window.HTMLLabelElement,
    HTMLLegendElement = _window.HTMLLegendElement,
    HTMLLinkElement = _window.HTMLLinkElement,
    HTMLLIElement = _window.HTMLLIElement,
    HTMLMapElement = _window.HTMLMapElement,
    HTMLMetaElement = _window.HTMLMetaElement,
    HTMLModElement = _window.HTMLModElement,
    HTMLObjectElement = _window.HTMLObjectElement,
    HTMLOListElement = _window.HTMLOListElement,
    HTMLOptGroupElement = _window.HTMLOptGroupElement,
    HTMLOptionElement = _window.HTMLOptionElement,
    HTMLParamElement = _window.HTMLParamElement,
    HTMLParagraphElement = _window.HTMLParagraphElement,
    HTMLPictureElement = _window.HTMLPictureElement,
    HTMLPreElement = _window.HTMLPreElement,
    HTMLProgressElement = _window.HTMLProgressElement,
    HTMLScriptElement = _window.HTMLScriptElement,
    HTMLSelectElement = _window.HTMLSelectElement,
    HTMLSpanElement = _window.HTMLSpanElement,
    HTMLStyleElement = _window.HTMLStyleElement,
    HTMLSourceElement = _window.HTMLSourceElement,
    HTMLTableCaptionElement = _window.HTMLTableCaptionElement,
    HTMLTableColElement = _window.HTMLTableColElement,
    HTMLTableElement = _window.HTMLTableElement,
    HTMLTextAreaElement = _window.HTMLTextAreaElement,
    HTMLTitleElement = _window.HTMLTitleElement,
    HTMLTrackElement = _window.HTMLTrackElement,
    HTMLQuoteElement = _window.HTMLQuoteElement,
    HTMLVideoElement = _window.HTMLVideoElement,
    HTMLUnknownElement = _window.HTMLUnknownElement,
    document = _window.document;
...
describe('htmlmodule library', function () {

    describe('HTMLElementAssembler', function () {
        describe('Simple empty span', function () {
            var node = new _index.HTMLElementAssembler({ localName: 'span' }).node;
            it('tagName', function () {
                assert.equal(node.tagName, 'SPAN');
            });
            it('proper inheritance', function () {
        ...
        describe('Unknown element', function () {
            it('unknown', function () {
                var node = new _index.HTMLElementAssembler({ localName: 'unknown' }).node;
                assert.equal(node.tagName, 'UNKNOWN');
                assert(node instanceof HTMLUnknownElement, node + ' instance of ' + HTMLUnknownElement);
            });
            it('foobar', function () {
                var node = new _index.HTMLElementAssembler({ localName: 'foobar' }).node;
                assert.equal(node.tagName, 'FOOBAR');
                assert(node instanceof HTMLUnknownElement, node + ' instance of ' + HTMLUnknownElement);
            });
            it('ari', function () {
                var node = new _index.HTMLElementAssembler({ localName: 'ari' }).node;
    ...
    describe('Global attributes', function () {
        ...
        describe('id', function () {
            var id = 'element_0';
            var node = (0, _index.div)({ id: id }).node;
        ...
        describe('className', function () {
            ...
            var node = (0, _index.span)({ className: className }).node;
        ...
        describe('HTMLElement attributes', function () {
            var node = (0, _index.div)({
                accessKey: 'A',
        ...
        describe('textContent', function () {
            var node = (0, _index.span)({ textContent: 'Arbitrary >< plain >< text' }).node;

            it('has no attributes', function () {
                assert(!node.hasAttributes(), 'has no attributes');
            });
            it('has child nodes', function () {
                assert(node.hasChildNodes(), 'has child nodes');
            });
            it('child nodes length', function () {
                assert.equal(node.childNodes.length, 1);
            });
        ...
        describe('innerHTML', function () {
            var node = (0, _index.div)({ innerHTML: '<span>1</span>2<span>3</span>' }).node;
    ...
    describe('Event handlers', function () {
        it('onblur', function () {
            ...
            var node = (0, _index.button)({ onblur: onblur }).node;
        ...
        it('onchange', function () {
            ...
            var node = (0, _index.input)({ type: 'checkbox', onchange: onchange }).node;
        ...
        it('onclick', function () {
            ...
            var node = (0, _index.button)({ onclick: onclick }).node;
        ...
        it('ondblclick', function () {
            var ondblclick = sinon.spy();
            var node = (0, _index.button)({ ondblclick: ondblclick }).node;
        ...
        it('onfocus', function () {
            ...
            var node = (0, _index.button)({ onfocus: onfocus }).node;
        ...
        it.skip('oninvalid', function () {
            // todo msie11
            var oninvalid = sinon.spy();
            var node = (0, _index.input)({
                required: true,
                oninvalid: oninvalid
            }).node;
        ...
        it.skip('onreset', function () {
            var onreset = sinon.spy();
            var children = (0, _index.input)({
                type: 'checkbox',
                checked: true
            }).node;
            var node = (0, _index.form)({ onreset: onreset, children: children }).node;
        ...
        it('onsubmit', function () {
            ...
            var children = (0, _index.button)().node;
            var node = (0, _index.form)({ onsubmit: onsubmit, children: children }).node;
        ...
        it('ontoggle', function () {
            ...
            var children = (0, _index.summary)();
            var node = (0, _index.details)({ ontoggle: ontoggle, children: children }).node;
    ...
    describe('Elements', function () {
        ...
        describe('address', function () {
            var node = (0, _index.address)('test@example.com').node;
            it('tagName', function () {
        ...
        describe('article', function () {
            var node = (0, _index.article)('Hello world!').node;
            it('tagName', function () {
        ...
        describe('aside', function () {
            var node = (0, _index.aside)('Your advert may be here!').node;
            it('tagName', function () {
        ...
        describe('audio', function () {
            ...
            it('proper constructor', function () {
                assert(node instanceof HTMLAudioElement, node + ' instance of ' + HTMLAudioElement);
            });
            it('has attributes', function () {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('b', function () {
            var node = (0, _index.b)('warning').node;
            it('tagName', function () {
        ...
        describe('base', function () {
            var node = (0, _index.base)({ href: 'https://w3.org', target: '_top' }).node;
            it('tagName', function () {
        ...
        describe('blockquote', function () {
            ...
            it('proper constructor', function () {
                assert( // msie11
                node instanceof HTMLQuoteElement || node instanceof HTMLBlockElement, node + ' instance of ' + HTMLQuoteElement);
            });
            it('has attributes', function () {
                assert(node.hasAttributes(), 'has attributes');
            });
            ...
            it('outerHTML', function () {
                assert.equal(node.outerHTML, '<blockquote ' + 'cite="https://html.spec.whatwg.org/#the-blockquote-element">' + 'The blockquote element represents a section that is quoted from another source.' + '</blockquote>');
            });
        });
        describe('body', function () {
            var node = (0, _index.body)('Test').node;
            it('tagName', function () {
        ...
        describe('button', function () {
            ...
            it.skip('proper attributes length', function () {
        ...
        describe('canvas', function () {
            var node = (0, _index.canvas)({ width: 100, height: 50 }).node;
            it('tagName', function () {
        ...
        describe('caption', function () {
            var node = (0, _index.caption)('Table 1. Total score obtained from rolling two six-sided dice.').node;
            it('tagName', function () {
        ...
        describe('cite', function () {
            var node = (0, _index.cite)('Fight club').node;
            it('tagName', function () {
        ...
        describe('col', function () {
            var node = (0, _index.col)({ span: 3 }).node;
            it('tagName', function () {
        ...
        describe('colgroup', function () {
            var node = (0, _index.colgroup)({ span: 5 }).node;
            it('tagName', function () {
        ...
        describe('datalist', function () {
            ...
            it('textContent', function () {
                assert.equal(node.outerHTML, '<datalist>' + '<option value="Female"></option>' + '<option value="Male"></option>' + '</datalist>');
            });
        });
        describe('dd', function () {
            var node = (0, _index.dd)('part of a term-description group in a description list').node;
            it('tagName', function () {
        ...
        describe('div', function () {
            var node = (0, _index.div)('Abstract grouping block-level container').node;
            it('tagName', function () {
        ...
        describe('dl', function () {
            var node = (0, _index.dl)({
                innerHTML: '<dt>dt</dt><dd>Description title</dd>' + '<dt>dd</dt><dd>Description description</dd>'
            }).node;
            it('tagName', function () {
            ...
            it('outerHTML', function () {
                assert.equal(node.outerHTML, '<dl>' + '<dt>dt</dt><dd>Description title</dd>' + '<dt>dd</dt><dd>Description description</dd>' + '</dl>');
            });
        });
        describe('dt', function () {
            var node = (0, _index.dt)('Description title').node;
            it('tagName', function () {
        ...
        describe('em', function () {
            var node = (0, _index.em)('Amazing!').node;
            it('tagName', function () {
        ...
        describe('figcaption', function () {
            var node = (0, _index.figcaption)('Image 1.1').node;
            it('tagName', function () {
        ...
        describe('figure', function () {
            var node = (0, _index.figure)({ innerHTML: '<img><figcaption>Figure #1.</figcaption>' }).node;
            it('tagName', function () {
        ...
        describe('footer', function () {
            var node = (0, _index.footer)('Navigation menu, small text, copyright and contact information').node;
            it('tagName', function () {
        ...
        describe('form', function () {
            var test = (0, _index.form)({
                ...
                noValidate: true,
                target: '_top',
                innerHTML: '<label><input></label>' + '<label><textarea></textarea></label>' + '<label><select>' + '<option></option>' + '<option></option>' + '</select></label>'
            });
            var node = test.node;
            it('tagName', function () {
            ...
            it('innerHTML', function () {
                assert.equal(node.innerHTML, '<label><input></label>' + '<label><textarea></textarea></label>' + '<label><select>' + '<option></option>' + '<option></option>' + '</select></label>');
            });
        });
        describe('h1', function () {
            var node = (0, _index.h1)('HTML Standard').node;
            it('tagName', function () {
        ...
        describe('h2', function () {
            var node = (0, _index.h2)('Full table of contents').node;
            it('tagName', function () {
        ...
        describe('h3', function () {
            var node = (0, _index.h3)('Introduction').node;
            it('tagName', function () {
        ...
        describe('h4', function () {
            var node = (0, _index.h4)('2.4 Common microsyntaxes').node;
            it('tagName', function () {
        ...
        describe('h5', function () {
            var node = (0, _index.h5)('2.4.4 Numbers').node;
            it('tagName', function () {
        ...
        describe('h6', function () {
            var node = (0, _index.h6)('2.4.4.4 Percentages and lengths').node;
            it('tagName', function () {
        ...
        describe('head', function () {
            ...
            it('outerHTML', function () {
                assert.equal(node.outerHTML, '<head><title></title><meta charset="utf-8"><link rel="stylesheet"></head>');
            });
        });
        describe('header', function () {
            var node = (0, _index.header)('The main heading, site navigation and search').node;
            it('tagName', function () {
        ...
        describe('hgroup', function () {
            ...
            it('outerHTML', function () {
                assert.equal(node.outerHTML, '<hgroup><h4>2.4 Common microsyntaxes</h4><h5>2.4.4 Numbers</h5></hgroup>');
            });
        });
        describe('hr', function () {
            var node = (0, _index.hr)().node;
            it('tagName', function () {
        ...
        describe('html', function () {
            var node = (0, _index.html)({
                attrset: { manifest: 'https://example.com/manifest' },
                innerHTML: '<head>' + '<meta charset="utf-8">' + '<title>Example document title</title>' + '</head>' + '<body>Example document body</body>'
            }).node;
            it('tagName', function () {
                assert.equal(node.tagName, 'HTML');
            });
            ...
            it('outerHTML', function () {
                assert.equal(node.outerHTML, '<html manifest="https://example.com/manifest">' + '<head>' + '<meta charset="utf-8">' + '<title>Example document title</title>' + '</head>' + '<body>Example document body</body>' + '</html>');
            });
        });
        describe('i', function () {
            var node = (0, _index.i)('Alternative voice').node;
            it('tagName', function () {
        ...
        describe('img', function () {
            var src = 'data:image/gif;base64,R0lGODdhMAAwAPAAAAAAAP///ywAAAAAMAAw' + 'AAAC8IyPqcvt3wCcDkiLc7C0qwyGHhSWpjQu5yqmCYsapyuvUUlvONmOZtfzgFz' + 'ByTB10QgxOR0TqBQejhRNzOfkVJ+5YiUqrXF5Y5lKh/DeuNcP5yLWGsEbtLiOSp' + 'a/TPg7JpJHxyendzWTBfX0cxOnKPjgBzi4diinWGdkF8kjdfnycQZXZeYGejmJl' + 'ZeGl9i2icVqaNVailT6F5iJ90m6mvuTS4OK05M0vDk0Q4XUtwvKOzrcd3iq9uis' + 'F81M1OIcR7lEewwcLp7tuNNkM3uNna3F2JQFo97Vriy/Xl4/f1cf5VWzXyym7PH' + 'hhx4dbgYKAAA7';
            var node = (0, _index.img)({
                alt: 'HTML logo',
                src: src,
                // todo msie11
        ...
        describe('input', function () {
            ...
            it.skip('formAction', function () {
                assert(node.formAction.endsWith('/app/save'), 'proper action');
            });
            it.skip('formEnctype', function () {
                assert.equal(node.formEnctype, 'multipart/form-data');
            });
            it.skip('formMethod', function () {
            ...
            it.skip('indeterminate', function () {
            ...
            it('form attribute', function () {
                assert.equal(node.getAttribute('form'), 'saveform');
            });
            it('list attribute', function () {
        ...
        describe('kbd', function () {
            var node = (0, _index.kbd)('Ctrl + Z').node;
            it('tagName', function () {
        ...
        describe('legend', function () {
            var node = (0, _index.legend)('Authorization').node;
            it('tagName', function () {
        ...
        describe('main', function () {
            var node = (0, _index.main)('The main application content').node;
            it('tagName', function () {
        ...
        describe('mark', function () {
            var node = (0, _index.mark)('Highlighted').node;
            it('tagName', function () {
        ...
        describe('meta', function () {
            ...
            it('httpEquiv', function () {
                assert.equal(node.httpEquiv, 'x-ua-compatible');
            });
            it('charset attribute', function () {
        ...
        describe('nav', function () {
            var node = (0, _index.nav)('Navigation area').node;
            it('tagName', function () {
        ...
        describe('noscript', function () {
            var node = (0, _index.noscript)('Alternative content').node;
            it('tagName', function () {
        ...
        describe('p', function () {
            var node = (0, _index.p)('Paragraph').node;
            it('tagName', function () {
        ...
        describe('param', function () {
            var node = (0, _index.param)({ name: 'ratio', value: '3' }).node;
            it('tagName', function () {
        ...
        describe('picture', function () {
            var node = (0, _index.picture)({ innerHTML: '<source><img>' }).node;
            it('tagName', function () {
        ...
        describe('pre', function () {
            var node = (0, _index.pre)('Pre >< formatted >< text').node;
            it('tagName', function () {
        ...
        describe('progress', function () {
            ...
            var node = (0, _index.progress)().node;
            it('tagName', function () {
        ...
        describe('q', function () {
            ...
            it('outerHTML', function () {
                assert.equal(node.outerHTML, '<q cite="https://html.spec.whatwg.org/#the-q-element">' + 'The q element represents some phrasing content quoted from another source' + '</q>');
            });
        });
        describe('s', function () {
            var node = (0, _index.s)('Not relevant').node;
            it('tagName', function () {
        ...
        describe('samp', function () {
            var node = (0, _index.samp)('example').node;
            it('tagName', function () {
        ...
        describe('script', function () {
            var node = (0, _index.script)({
                ...
                // crossOrigin : 'use-credentials', // todo msie11
                // nonce : 'abc', // todo
                children: _index.script.toString()
            }).node;
            it('tagName', function () {
            ...
            it('textContent', function () {
                assert.equal(node.textContent, _index.script.toString());
            });
        });
        describe('section', function () {
            var node = (0, _index.section)('Application section').node;
            it('tagName', function () {
        ...
        describe('select', function () {
            var node = (0, _index.select)({
                ...
                size: 10,
                attrset: { form: 'saveform' },
                innerHTML: '<option>opt1</option>' + '<optgroup><option>opt2</option></optgroup>' + '<option>opt3</option>'
            }).node;
            it('tagName', function () {
            ...
            it('innerHTML', function () {
                assert.equal(node.innerHTML, '<option>opt1</option>' + '<optgroup><option>opt2</option></optgroup>' + '<option>opt3</option>');
            });
        });
        describe('small', function () {
            var node = (0, _index.small)('Copyright © Vyacheslav Aritov').node;
            it('tagName', function () {
        ...
        describe('table', function () {
            var node = (0, _index.table)({
                innerHTML: '<tr><td>A1</td><td>A2</td><td>A3</td></tr>' + '<tr><td>B1</td><td>B2</td><td>B3</td></tr>'
            }).node;
            it('tagName', function () {
            ...
            it('firstChild.tagName', function () {
                assert.equal(node.firstChild.tagName, 'TBODY');
            });
            it('outerHTML', function () {
                assert.equal(node.outerHTML, '<table>' + '<tbody>' + '<tr><td>A1</td><td>A2</td><td>A3</td></tr>' + '<tr><td>B1</td><td>B2</td><td>B3</td></tr>' + '</tbody>' + '</table>');
            });
        });
        describe('textarea', function () {
            var node = (0, _index.textarea)({
                // autocomplete : 'off', // todo
                autofocus: true,
                cols: 15,
                // dirName : 'comment.dir', // todo firefox
        ...
        describe('title', function () {
            var node = (0, _index.title)('Application title').node;
            it('tagName', function () {
        ...
        describe('u', function () {
            var node = (0, _index.u)('Misspelt text').node;
            it('tagName', function () {
        ...
        describe('video', function () {
            var poster = 'data:image/gif;base64,R0lGODdhMAAwAPAAAAAAAP///ywAAAAAMAAw' + 'AAAC8IyPqcvt3wCcDkiLc7C0qwyGHhSWpjQu5yqmCYsapyuvUUlvONmOZtfzgFz' + 'ByTB10QgxOR0TqBQejhRNzOfkVJ+5YiUqrXF5Y5lKh/DeuNcP5yLWGsEbtLiOSp' + 'a/TPg7JpJHxyendzWTBfX0cxOnKPjgBzi4diinWGdkF8kjdfnycQZXZeYGejmJl' + 'ZeGl9i2icVqaNVailT6F5iJ90m6mvuTS4OK05M0vDk0Q4XUtwvKOzrcd3iq9uis' + 'F81M1OIcR7lEewwcLp7tuNNkM3uNna3F2JQFo97Vriy/Xl4/f1cf5VWzXyym7PH' + 'hhx4dbgYKAAA7';
            var node = (0, _index.video)({
            ...
            it('proper constructor', function () {
                assert(node instanceof HTMLVideoElement, node + ' instance of ' + HTMLVideoElement);
            });
            it('has attributes', function () {
                assert(node.hasAttributes(), 'has attributes');
            });
    ...
    describe('Various structures', function () {
        describe('Authorization fieldset', function () {
            it('properly build form authorization fieldset', function () {
                var node = (0, _index.fieldset)([(0, _index.legend)('Authorization'), (0, _index.input)({ type: 'email' }), (0, _index.input)({ type: 'password' })]).node;
                assert.equal(node.outerHTML, '<fieldset>' + '<legend>Authorization</legend>' + '<input type="email">' + '<input type="password">' + '</fieldset>');
            });
        });
        describe('Header with navigation', function () {
            it('properly build header with navigational links inside', function () {
                var node = (0, _index.header)((0, _index.nav)([(0, _index.a)({ href: '/lib.html', textContent: 'Library' }), (0, _index.a)({ href: '/spec.html', textContent: 'Specifications' }), (0, _index.a)({ href: '/home.html', textContent: 'Go home' })])).node;
                assert.equal(node.outerHTML, '<header><nav>' + '<a href="/lib.html">Library</a>' + '<a href="/spec.html">Specifications</a>' + '<a href="/home.html">Go home</a>' + '</nav></header>');
            });
        });
        describe('Select box widget', function () {
            var widget = void 0,
                selected = void 0;
            var node = (0, _index.label)(['Select technology ', widget = (0, _index.select)([(0, _index.option)('DOM'), (0, _index.option)('XML'), selected = (0, _index.option)({ selected: true, textContent: 'HTML' }).node, (0, _index.option)('SVG'), (0, _index.option)('MathML'), (0, _index.option)('WAI-ARIA')]).node]).node;
            it('properly build label with select box option list inside', function () {
                assert.equal(node.outerHTML, '<label>' + 'Select technology ' + '<select>' + '<option>DOM</option>' + '<option>XML</option>' + '<option>HTML</option>' + '<option>SVG</option>' + '<option>MathML</option>' + '<option>WAI-ARIA</option>' + '</select>' + '</label>');
            });
        ...
        describe('Search form', function () {
            it('properly build form with search input and submit button inside', function () {
                var node = (0, _index.form)({
                    attrset: { role: 'search' },
                    children: [(0, _index.input)({ type: 'search' }), (0, _index.button)('Search')]
                }).node;
                assert.equal(node.outerHTML, '<form role="search">' + '<input type="search">' + '<button>Search</button>' + '</form>');
            });
        });
        describe.skip('Checkboxes', function () {
            ...
            var node = (0, _index.div)([simple = (0, _index.input)({ type: 'checkbox' }), checked = (0, _index.input)({ type: 'checkbox', checked: true })]
            // indeterminate = input({ type : 'checkbox', indeterminate : true })
            );
            it('proper HTML rendered', function () {
                assert.equal(node.outerHTML, '<div>' + '<input type="checkbox">' + '<input type="checkbox">' + '<input type="checkbox">' + '</div>');
            });
            ...
            it('proper initial state assignment', function () {
                var sample = (0, _index.input)({ type: 'checkbox', attrset: { checked: '' } });
                var container = (0, _index.div)({ innerHTML: '<input type=checkbox checked>' });
                assert(sample.isEqualNode(container.firstChild));
            });
        });
        describe('Various list examples', function () {
            it('properly build ul + li', function () {
                assert.equal((0, _index.ul)([(0, _index.li)('Ampeg'), (0, _index.li)('Fender'), (0, _index.li)('Warwick')]).node.outerHTML, '<ul>' + '<li>Ampeg</li>' + '<li>Fender</li>' + '<li>Warwick</li>' + '</ul>');
            });
            it('properly build ol + li', function () {
                assert.equal((0, _index.ol)([(0, _index.li)('Moscow'), (0, _index.li)('Amsterdam'), (0, _index.li)('New York')]).node.outerHTML, '<ol>' + '<li>Moscow</li>' + '<li>Amsterdam</li>' + '<li>New York</li>' + '</ol>');
            });
            it('properly build dl + dt + dd', function () {
                assert.equal((0, _index.dl)([(0, _index.dt)('DOM'), (0, _index.dd)('Document object model'), (0, _index.dt)('XML'), (0, _index.dd)('Extensible markup language'), (0, _index.dt)('HTML'), (0, _index.dd)('Hyper text markup language')]).node.outerHTML, '<dl>' + '<dt>DOM</dt>' + '<dd>Document object model</dd>' + '<dt>XML</dt>' + '<dd>Extensible markup language</dd>' + '<dt>HTML</dt>' + '<dd>Hyper text markup language</dd>' + '</dl>');
            });
        });
        describe('Details with summary', function () {
            it('properly build widget', function () {
                var node = (0, _index.details)([(0, _index.summary)('Show details'), 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, ', 'sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.']).node;
                assert.equal(node.outerHTML, '<details>' + '<summary>Show details</summary>' + 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, ' + 'sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' + '</details>');
            });
        });
        describe('Table', function () {
            it('properly build widget', function () {
                var node = (0, _index.table)([(0, _index.caption)('Related semantics'), (0, _index.thead)((0, _index.tr)([(0, _index.th)((0, _index.abbr)('HTML')), (0, _index.th)((0, _index.abbr)('WAI-ARIA'))])), (0, _index.tbody)([['button', 'button'], ['a, link, area', 'link'], ['input', 'textbox'], ['select', 'combobox'], ['table', 'table, grid'], ['ul, ol', 'list']].map(function (_ref) {
                    var _ref2 = _slicedToArray(_ref, 2),
                        xmlterm = _ref2[0],
                        htmlterm = _ref2[1];

                    return (0, _index.tr)([(0, _index.td)((0, _index.code)(xmlterm)), (0, _index.td)((0, _index.code)(htmlterm))]);
                })), (0, _index.tfoot)([(0, _index.tr)([(0, _index.th)('9'), (0, _index.th)('7')])])]).node;
                assert.equal(node.outerHTML, '<table>' + '<caption>Related semantics</caption>' + '<thead><tr>' + '<th><abbr>HTML</abbr></th><th><abbr>WAI-ARIA</abbr></th>' + '</tr></thead>' + '<tbody>' + '<tr><td><code>button</code></td><td><code>button</code></td></tr>' + '<tr><td><code>a, link, area</code></td><td><code>link</code></td></tr>' + '<tr><td><code>input</code></td><td><code>textbox</code></td></tr>' + '<tr><td><code>select</code></td><td><code>combobox</code></td></tr>' + '<tr><td><code>table</code></td><td><code>table, grid</code></td></tr>' + '<tr><td><code>ul, ol</code></td><td><code>list</code></td></tr>' + '</tbody>' + '<tfoot><tr><th>9</th><th>7</th></tr></tfoot>' + '</table>');
            });
        });
        describe('Ruby annotations', function () {
            it('properly build DOM structure', function () {
                var node = (0, _index.article)([(0, _index.h1)('Ruby annotations'), (0, _index.section)([(0, _index.ruby)(['君', (0, _index.rt)('くん')]), (0, _index.ruby)(['子', (0, _index.rt)('し')]), 'は', (0, _index.ruby)(['和', (0, _index.rt)('わ')]), 'して', (0, _index.ruby)(['同', (0, _index.rt)('どう')]), 'ぜず。']), (0, _index.section)((0, _index.ruby)(['漢', (0, _index.rp)(' ('), (0, _index.rt)('かん'), (0, _index.rp)(')'), '字', (0, _index.rp)(' ('), (0, _index.rt)('じ'), (0, _index.rp)(')')]))]).node;
                assert.equal(node.outerHTML, '<article>' + '<h1>Ruby annotations</h1>' + '<section>' + '<ruby>君<rt>くん</rt></ruby><ruby>子<rt>し</rt></ruby>は' + '<ruby>和<rt>わ</rt></ruby>して<ruby>同<rt>どう</rt></ruby>ぜず。' + '</section>' + '<section>' + '<ruby>' + '漢<rp> (</rp><rt>かん</rt><rp>)</rp>' + '字<rp> (</rp><rt>じ</rt><rp>)</rp>' + '</ruby>' + '</section>' + '</article>');
            });
        });
        describe('Bidirectional', function () {
            it('properly build DOM structure', function () {
                var children = 'АРОЗАУПАЛА';
                var node = (0, _index.article)([(0, _index.h1)('Bidirectional'), (0, _index.section)([children, 'Н', (0, _index.bdo)({ dir: 'rtl', children: children })]), (0, _index.ul)([(0, _index.li)(['User ', (0, _index.bdi)('jcranmer'), ': 12 posts.']), (0, _index.li)(['User ', (0, _index.bdi)('hober'), ': 5 posts.']), (0, _index.li)(['User ', (0, _index.bdi)('إيان'), ': 3 posts.'])])]).node;
                assert.equal(node.outerHTML, '<article>' + '<h1>Bidirectional</h1>' + '<section>АРОЗАУПАЛАН<bdo dir="rtl">АРОЗАУПАЛА</bdo></section>' + '<ul>' + '<li>User <bdi>jcranmer</bdi>: 12 posts.</li>' + '<li>User <bdi>hober</bdi>: 5 posts.</li>' + '<li>User <bdi>إيان</bdi>: 3 posts.</li>' + '</ul>' + '</article>');
            });
        });
        describe('Other', function () {
            it('property build DOM fragment', function () {
                var node = (0, _index.main)([(0, _index.section)((0, _index.dfn)('htmlmodule — DOM assembler library')), (0, _index.section)((0, _index.p)([(0, _index.variable)('var'), ' — is reserved JavaScript keyword, ', 'so we use `variable` function name instead.'])), (0, _index.section)([(0, _index.sup)('supertext'), (0, _index.sub)('subtext'), (0, _index.i)('alternative voice'), (0, _index.strong)('important!')])]).node;
                assert.equal(node.outerHTML, '<main>' + '<section><dfn>' + 'htmlmodule — DOM assembler library' + '</dfn></section>' + '<section><p>' + '<var>var</var>' + ' — is reserved JavaScript keyword, ' + 'so we use `variable` function name instead.' + '</p></section>' + '<section>' + '<sup>supertext</sup>' + '<sub>subtext</sub>' + '<i>alternative voice</i>' + '<strong>important!</strong>' + '</section>' + '</main>');
            });
            it('HTMLElementAssembler, span', function () {
                var node1 = new _index.HTMLElementAssembler({
                    localName: 'span',
                    id: '00101',
                    className: 'fa fi fu',
                    tabIndex: 0,
                    children: ['a', (0, _index.span)('a b'), 'b']
                }).node;
                var node2 = (0, _index.span)({
                    ...
                    tabIndex: 0,
                    children: ['a', (0, _index.span)('a b'), 'b']
                }).node;[node1, node2].forEach(function (node) {
...
var _abbr = __webpack_require__(47);
...
var _area = __webpack_require__(49);
...
var _article = __webpack_require__(50);
...
var _bdi = __webpack_require__(55);
...
var _bdo = __webpack_require__(56);
...
var _br = __webpack_require__(59);
...
var _caption = __webpack_require__(62);
...
var _cite = __webpack_require__(63);
...
var _colgroup = __webpack_require__(66);
...
var _datalist = __webpack_require__(68);
...
var _dd = __webpack_require__(69);
...
var _del = __webpack_require__(70);
...
var _dfn = __webpack_require__(72);
...
var _dt = __webpack_require__(77);
...
var _em = __webpack_require__(78);
...
var _fieldset = __webpack_require__(80);
...
var _figcaption = __webpack_require__(81);
...
var _figure = __webpack_require__(82);
...
var _h2 = __webpack_require__(86);
...
var _h3 = __webpack_require__(87);
...
var _h4 = __webpack_require__(88);
...
var _h5 = __webpack_require__(89);
...
var _h6 = __webpack_require__(90);
...
var _hgroup = __webpack_require__(93);
...
var _iframe = __webpack_require__(96);
...
var _img = __webpack_require__(97);
...
var _ins = __webpack_require__(99);
...
var _kbd = __webpack_require__(100);
...
var _legend = __webpack_require__(102);
...
var _li = __webpack_require__(103);
...
var _mark = __webpack_require__(107);
...
var _meta = __webpack_require__(109);
...
var _meter = __webpack_require__(110);
...
var _noscript = __webpack_require__(112);
...
var _ol = __webpack_require__(114);
...
var _output = __webpack_require__(117);
...
var _p = __webpack_require__(118);
...
var _param = __webpack_require__(119);
...
var _picture = __webpack_require__(120);
...
var _pre = __webpack_require__(121);
...
var _q = __webpack_require__(123);
...
var _rp = __webpack_require__(124);
...
var _rt = __webpack_require__(125);
...
var _ruby = __webpack_require__(126);
...
var _s = __webpack_require__(127);
...
var _samp = __webpack_require__(128);
...
var _script = __webpack_require__(129);
...
var _section = __webpack_require__(130);
...
var _small = __webpack_require__(132);
...
var _source = __webpack_require__(133);
...
var _span = __webpack_require__(134);
...
var _strong = __webpack_require__(135);
...
var _sub = __webpack_require__(137);
...
var _summary = __webpack_require__(138);
...
var _sup = __webpack_require__(139);
...
var _tbody = __webpack_require__(141);
...
var _td = __webpack_require__(142);
...
var _tfoot = __webpack_require__(145);
...
var _th = __webpack_require__(146);
...
var _thead = __webpack_require__(147);
...
var _time = __webpack_require__(148);
...
var _tr = __webpack_require__(150);
...
var _track = __webpack_require__(151);
...
var _u = __webpack_require__(152);
...
var _ul = __webpack_require__(153);
...
var _var = __webpack_require__(154);
...
var _wbr = __webpack_require__(156);
