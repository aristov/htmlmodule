{
    ...
    const pathinfo = article({
        ...
        children : [
            ...
            p({
                innerHTML : ['Мы располагаемся в <b>Москве</b>,',
                    'недалеко от станции <b>метро «Улица 1905 года»</b>.',
                    'Удобнее выходить у последнего вагона из центра.',
                    'Из выхода в подземный переход, перейти перекресток по диагонали и идти вдоль',
                    'Звенигородского шоссе в сторону области до <b>2-й Звенигородской улицы</b>,',
                    'перейти догогу, затем свернуть налево, пройти ~100м, рядом с магазином «Пятерочка»',
                    'металлические ворота со шлагбаумом и калиткой — зайти в нее,',
                    'обойти 15-е строение слева, и снова в калитку — слева будет',
                    '<b>вход в кафе с вывеской «PH & B»</b>.',
            ...
            address([
                figure([
                    figcaption(a({
                        ...
                        rel : 'external',
                        target : 'blank',
                        innerHTML : 'Москва, <b>2</b>-я Звенигородская <b>13</b> <sup>строение <b>17</b></sup>'
                    })),
                    pathmap,
                ])
            ]),
    ...
    const indexpage = article({
        ...
        children : [
            ...
            section([
                h1('Место'),
                ul([
                    li(['3 зала для репетиций ', b(['25-30 м', sup('2')])]),
                    li(['Концертный зал с окном ', b(['50 м', sup('2')])]),
                    li(['Малый зал для занятий ', b(['20 м', sup('2')])])
                ]),
            ]),
            section([
                h1('Возможности'),
            ...
            section([
                ...
                p({
                    ...
                    children : [
                        ...
                        ...('Ampeg, EBS, Fender, JBL, Kustom, Mackie, Peavey, ' +
                        'Randall, Roland, Sabian, Shure, Sonor, Soundcraft, VOX, Yamaha')
                            .split(', ').map((name, i) => [i && ', ', b(name)]),
