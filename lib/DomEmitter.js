 ...
 */
export class DomEmitter extends Assembler
{
  /**
   * @returns {EventTarget}
   */
   ...
   * @param {{context,capture,once,passive}|boolean|DomEmitter|*} [options]
   * @param {DomEmitter} [options.context=this]
  ...
  on(eventName, callback, options = {}) {
    ...
    else if(options instanceof DomEmitter) {
   ...
   * @param {string} eventName
   * @param {function} callback
   * @param {{context,capture}|boolean|DomEmitter|*} [options]
   * @param {DomEmitter} [options.context=this]
   * @param {boolean} [options.capture=false]
   */
...
DomEmitter.defineEvents(Object.keys(DomEmitter.events))
