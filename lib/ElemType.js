...
class ElemType
{
  ...
  on(eventName, callback, options = {}) {
    ...
    const listener = e => {
      ...
      callback.call(this, e, this.__getByNode(e.target))
    }
    ...
    for(const type of types) {
      ...
      Object.defineProperty(ElemType.prototype, name, {
        ...
        set(callback) {
          ...
          const listener = e => {
            return callback.call(this, e, this.__getByNode(e.target))
          }
          if(!this.__handlers) {
            this.__handlers = new Map
            this.__handlers.__updates = new Map
...
ElemType.defineHanlders(Object.keys(EventType))
