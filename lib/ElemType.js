...
class ElemType
{
  ...
  constructor(props = {}) {
    ...
    this.props = props.constructor === Object ? props : { children : props }
    this.children = []
    this.refs = {}
  ...
  setClassName() {
    ...
    do {
      ...
      name = constructor.hasOwnProperty('class') && constructor.class || constructor.name
      if(!name) {
        break
      }
  ...
  _render() {
    ...
    this.children = normalizeChildren(this.render())
    this.setChildren()
    for(const [key, elem] of Object.entries(refs)) {
      if(this.node.contains(elem.node)) {
        this.refs[key] = elem
      }
    }
  }
