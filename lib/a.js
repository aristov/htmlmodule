import { HTMLHyperlinkAssembler } from './hyperlink'
 ...
 */
export class A extends HTMLHyperlinkAssembler {
    /**
     * @param {string} target
     */
    set target(target) {
    ...
    /**
     * @returns {interface} HTMLAnchorElement
     * @override
     */
    static get interface() {
        return HTMLAnchorElement || super.interface
    }
}
