 ...
 */
export class HTMLInput extends HTMLElementAssembler {
    /**
     * @returns {boolean}
     */
    checkValidity() {
     ...
     */
    get list() {
        return this.getInstanceOf(this.node.list)
    }
    ...
    /**
     * @returns {interface} HTMLInputElement
     * @override
     */
    static get interface() {
        return HTMLInputElement || super.interface
    }
}
