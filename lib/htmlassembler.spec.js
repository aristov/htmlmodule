...
import { htmlEqualMarkup } from './util/htmlequalmarkup.js';
    ...
    describe('createElement', () => {
        ...
        describe('adapted interface', () => {
            ...
            describe('attrset', () => {
                ...
                const element = assembler.createElement('option', init);
                it('proper number of attributes', () => {
                    assert(element.hasAttributes(), 'element has attributes');
                    assert.equal(element.attributes.length, 1);
                });
            ...
            describe('children', () => {
                const child = new HTMLAssembler;
                child.createElement('span');
                const element = assembler.createElement('div', {
                    children : [
                        0,
                        assembler.createElement('button'),
                        '',
                        'text node as string',
                        NaN,
