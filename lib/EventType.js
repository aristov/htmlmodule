...
class EventType
{
   ...
   */
  get relatedTarget() {
    return this.currentTarget.rootElem.getElemByNode(this.nativeEvent.relatedTarget)
  }
   ...
   */
  get submitter() {
    return this.currentTarget.getElemByNode(this.nativeEvent.submitter)
  }
