...
export class HTMLElementAssembler extends ElementAssembler {
     ...
     */
    set name(name) {
        if(NAME_PROPERTY_NAME in this.node) {
            this.node.name = name
        }
        else this.onPropertyMismatch(NAME_PROPERTY_NAME)
    }
    ...
    static get localName() {
        ...
        if(this === superAssembler) return LOCAL_NAME
        else {
            let object = this
            let proto
