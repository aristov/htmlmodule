...
export class Table extends HTMLElementAssembler {
     ...
     */
    createCaption() {
        return this.getInstance(this.node.createCaption(), Caption)
    }
     ...
     */
    createTHead() {
        return this.getInstance(this.node.createTHead(), THead)
    }
     ...
     */
    createTFoot() {
        return this.getInstance(this.node.createTFoot(), TFoot)
    }
     ...
     */
    createTBody() {
        return this.getInstance(this.node.createTBody(), TBody)
    }
     ...
     */
    insertRow(index) {
        return this.getInstance(this.node.insertRow(index), Tr)
    }
     ...
     */
    get tHead() {
        return this.getInstance(this.node.tHead, THead)
    }
     ...
     */
    get tFoot() {
        return this.getInstance(this.node.tFoot, TFoot)
    }
    ...
    get tBodies() {
        return map.call(this.node.tBodies, node => {
            return this.getInstance(node, TBody)
        })
    }
    ...
    get rows() {
        return map.call(this.node.rows, node => {
            return this.getInstance(node, Tr)
        })
    }
