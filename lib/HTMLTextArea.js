 ...
 */
export class HTMLTextArea extends HTMLElementAssembler {
    /**
     * @returns {boolean}
     */
    checkValidity() {
    ...
    /**
     * @returns {interface} HTMLTextAreaElement
     * @override
     */
    static get interface() {
        return HTMLTextAreaElement || super.interface
    }
}
...
export function textarea(init) {
    return new HTMLTextArea(init)
}

HTMLTextArea.register()
