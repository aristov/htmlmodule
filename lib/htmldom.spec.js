    ...
    describe('Single elements', () => {
        describe('a', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLAnchorElement.name);
            });
            it('has attributes', () => {
        ...
        describe('abbr', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('area', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLAreaElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('base', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLBaseElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('blockquote', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLQuoteElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('body', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLBodyElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('br', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLBRElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('button', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLButtonElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('caption', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLTableCaptionElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('col', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLTableColElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('del', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLModElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('div', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLDivElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('dl', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLDListElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('embed', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLEmbedElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('fieldset', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLFieldSetElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
            ...
            it('outerHTML', () => {
                assert.equal(node.outerHTML,
                    '<fieldset disabled=""><input><input type="submit"></fieldset>');
            });
        });
        describe('figcaption', () => {
        ...
        describe('form', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLFormElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('h1', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLHeadingElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('head', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLHeadElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('hr', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLHRElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('html', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLHtmlElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('iframe', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLIFrameElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('img', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLImageElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('input', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLInputElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('label', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLLabelElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('legend', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLLegendElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('li', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLLIElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('link', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLLinkElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('map', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLMapElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('meta', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLMetaElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('object', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLObjectElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('ol', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLOListElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('optgroup', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLOptGroupElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('option', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLOptionElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        /*describe('output', () => { // todo msie11
            ...
            it.skip('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLOutputElement.name);
            });
        ...
        describe('p', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLParagraphElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('param', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLParamElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('pre', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLPreElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('script', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLScriptElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('select', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLSelectElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('style', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLStyleElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('table', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLTableElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('textarea', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLTextAreaElement.name);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('title', () => {
            ...
            it('proper constructor', () => {
                assert.equal(node.constructor.name, HTMLTitleElement.name);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('Other', () => {
            ...
            it('htmldom, span', () => {
                ...
                [node1, node2].forEach(node => {
                    ...
                    assert.equal(node.constructor.name, HTMLSpanElement.name);
                    assert.equal(node.attributes.length, 3);
