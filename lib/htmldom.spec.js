...
describe('HTMLDOM library', () => {
    ...
    describe('Single elements', () => {
        ...
        describe('audio', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLAudioElement,
                    node.constructor + ' instance of ' + HTMLAudioElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('canvas', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLCanvasElement, node.constructor + ' instance of ' + HTMLCanvasElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('datalist', () => {
            ...
            it.skip('proper constructor', () => { // todo safari
                assert(node instanceof HTMLDataListElement, node.constructor + ' instance of ' + HTMLDataListElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('progress', () => {
            const node = progress({ value : 6, max : 10 });
            it('tagName', () => {
                assert.equal(node.tagName, 'PROGRESS');
            });
            it('proper constructor', () => {
                assert(node instanceof HTMLProgressElement, node.constructor + ' instance of ' + HTMLProgressElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('video', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLVideoElement,
                    node.constructor + ' instance of ' + HTMLVideoElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
