...
describe('HTMLDOM library', () => {
    ...
    describe('Event handlers', () => {
        it('onblur', () => {
            ...
            // element.blur(); // fixme doesn't work on karma + firefox | opera | msie
        ...
        it('onchange', () => {
            ...
            assert(!element.checked, 'not checked before click');
            element.click();
            assert(onchange.calledOnce, 'called once on click');
            assert(element.checked, 'checked on click');
            element.click();
            assert(onchange.calledTwice, 'called twice on the second click');
            assert(!element.checked, 'not checked on the second click');
            document.body.removeChild(element);
        });
        it('onclick', () => {
        ...
        it('onfocus', () => {
            ...
            element.focus(); // fixme doesn't work on karma + firefox | opera | msie
        ...
        it('onreset', () => {
            ...
            const element = htmldom('form', { onreset, children });
        ...
        it('onsubmit', () => {
            ...
            const element = htmldom('form', { onsubmit, children });
    ...
    describe('Single elements', () => {
        ...
        describe('audio', () => {
            ...
            it('src', () => {
                assert(node.src.endsWith('docs/data/sample.wav'), 'proper src');
            });
            it.skip('crossOrigin', () => {
        ...
        describe('video', () => {
            const node = video({
                src : '../../docs/data/sample.mov',
                // crossOrigin : 'use-credentials', // fixme msie11
                poster : '../../docs/data/sample.png',
                preload : 'metadata',
                autoplay : true,
            ...
            it('src', () => {
                assert(node.src.endsWith('docs/data/sample.mov'), 'proper src');
            });
            it.skip('crossOrigin', () => {
                assert.equal(node.crossOrigin, 'use-credentials');
            });
            it('poster', () => {
                assert(node.poster.endsWith('docs/data/sample.png'), 'proper poster');
            });
            it('preload', () => {
                assert.equal(node.preload, 'metadata');
            });
