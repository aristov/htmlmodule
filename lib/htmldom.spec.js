...
describe('HTMLDOM library', () => {
    ...
    describe('Global attributes', () => {
        ...
        describe('id', () => {
            ...
            it('id attribute', () => {
                assert.equal(element.getAttribute('id'), id);
            });
            ...
            it('outerHTML', () => {
                assert.equal(element.outerHTML, '<div id="element_0"></div>');
            });
        });

        describe('className', () => {
            const className = 'foo bar wiz';
            const element = htmldom('span', { className });
            ...
            it('outerHTML', () => {
                assert.equal(element.outerHTML, '<span class="foo bar wiz"></span>');
            });
        });

        describe('attributes', () => {
            const element = htmldom('div', {
                accessKey : 'A',
            ...
            it('attributes length', () => {
                assert.equal(element.attributes.length, 8);
            });
            it('accessKey', () => {
            ...
            it('title', () => {
                assert.equal(element.title, 'HTMLElement title');
            });
            it('title attribute', () => {
                assert.equal(element.getAttribute('title'), 'HTMLElement title');
            });
        });
    ...
    describe('Single elements', () => {
        describe('a', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLAnchorElement, node.constructor + ' instance of ' + HTMLAnchorElement);
            });
            it('has attributes', () => {
        ...
        describe('abbr', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLElement, node.constructor + ' instance of ' + HTMLElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('area', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLAreaElement, node.constructor + ' instance of ' + HTMLAreaElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('base', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLBaseElement, node.constructor + ' instance of ' + HTMLBaseElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('blockquote', () => {
            ...
            it('proper constructor', () => {
                assert( // msie11
                    ...
                    node.constructor + ' instance of ' + HTMLQuoteElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('body', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLBodyElement, node.constructor + ' instance of ' + HTMLBodyElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('br', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLBRElement, node.constructor + ' instance of ' + HTMLBRElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('button', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLButtonElement, node.constructor + ' instance of ' + HTMLButtonElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('caption', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLTableCaptionElement, node.constructor + ' instance of ' + HTMLTableCaptionElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('col', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLTableColElement, node.constructor + ' instance of ' + HTMLTableColElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('del', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLModElement, node.constructor + ' instance of ' + HTMLModElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('div', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLDivElement, node.constructor + ' instance of ' + HTMLDivElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('dl', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLDListElement, node.constructor + ' instance of ' + HTMLDListElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('embed', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLEmbedElement, node.constructor + ' instance of ' + HTMLEmbedElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('fieldset', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLFieldSetElement, node.constructor + ' instance of ' + HTMLFieldSetElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('form', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLFormElement, node.constructor + ' instance of ' + HTMLFormElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('h1', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLHeadingElement, node.constructor + ' instance of ' + HTMLHeadingElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('head', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLHeadElement, node.constructor + ' instance of ' + HTMLHeadElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('hr', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLHRElement, node.constructor + ' instance of ' + HTMLHRElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('html', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLHtmlElement, node.constructor + ' instance of ' + HTMLHtmlElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('iframe', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLIFrameElement, node.constructor + ' instance of ' + HTMLIFrameElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('img', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLImageElement, node.constructor + ' instance of ' + HTMLImageElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('input', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLInputElement, node.constructor + ' instance of ' + HTMLInputElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('label', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLLabelElement, node.constructor + ' instance of ' + HTMLLabelElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('legend', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLLegendElement, node.constructor + ' instance of ' + HTMLLegendElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('li', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLLIElement, node.constructor + ' instance of ' + HTMLLIElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('link', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLLinkElement, node.constructor + ' instance of ' + HTMLLinkElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('map', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLMapElement, node.constructor + ' instance of ' + HTMLMapElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('meta', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLMetaElement, node.constructor + ' instance of ' + HTMLMetaElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('object', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLObjectElement, node.constructor + ' instance of ' + HTMLObjectElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('ol', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLOListElement, node.constructor + ' instance of ' + HTMLOListElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('optgroup', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLOptGroupElement, node.constructor + ' instance of ' + HTMLOptGroupElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('option', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLOptionElement, node.constructor + ' instance of ' + HTMLOptionElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        /*describe('output', () => { // todo msie11
            ...
            it.skip('proper constructor', () => {
                assert(node instanceof HTMLOutputElement, node.constructor + ' instance of ' + HTMLOutputElement);
            });
        ...
        describe('p', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLParagraphElement, node.constructor + ' instance of ' + HTMLParagraphElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('param', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLParamElement, node.constructor + ' instance of ' + HTMLParamElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('pre', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLPreElement, node.constructor + ' instance of ' + HTMLPreElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('q', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLQuoteElement, node.constructor + ' instance of ' + HTMLQuoteElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('script', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLScriptElement, node.constructor + ' instance of ' + HTMLScriptElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('select', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLSelectElement, node.constructor + ' instance of ' + HTMLSelectElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('style', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLStyleElement, node.constructor + ' instance of ' + HTMLStyleElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('table', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLTableElement, node.constructor + ' instance of ' + HTMLTableElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('textarea', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLTextAreaElement, node.constructor + ' instance of ' + HTMLTextAreaElement);
            });
            it('has attributes', () => {
                assert(node.hasAttributes(), 'has attributes');
            });
        ...
        describe('title', () => {
            ...
            it('proper constructor', () => {
                assert(node instanceof HTMLTitleElement, node.constructor + ' instance of ' + HTMLTitleElement);
            });
            it('has no attributes', () => {
                assert(!node.hasAttributes(), 'has no attributes');
            });
        ...
        describe('Other', () => {
            ...
            it('htmldom, span', () => {
                ...
                [node1, node2].forEach(node => {
                    ...
                    assert(node instanceof HTMLSpanElement, node.constructor + ' instance of ' + HTMLSpanElement);
                    assert.equal(node.attributes.length, 3);
