...
import { htmlEqualMarkup } from './util/htmlequalmarkup';
...
describe('HTMLDOM library', () => {
    describe('Elements', () => {
        it('a', () => {
            ...
            assert(
                htmlEqualMarkup(node,
                    '<a href=html://www.aria.dom/math.svg ' +
                        'rel=next ' +
                        'title="om dom dom dom d">DOM module</a>'));
        });
        it('abbr', () => {
            const node = abbr({
            ...
            assert(
                htmlEqualMarkup(node, '<abbr title="Hyper text markup language">HTML</abbr>'),
                'properly build node');
        });
        it('address', () => {
            const node = address('vasily@pupkin.ru');
            assert(
                htmlEqualMarkup(node, '<address>vasily@pupkin.ru</address>'),
                'properly build node');
        });
        it('article', () => {
            const node = article('Hello world!');
            assert(
                htmlEqualMarkup(node, '<article>Hello world!</article>'),
                'properly build node');
        });
        it('aside', () => {
            const node = aside('Your advert may be here!');
            assert(
                htmlEqualMarkup(node, '<aside>Your advert may be here!</aside>'),
                'properly build node');
        });
    });
