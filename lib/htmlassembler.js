...
/**
 * XHTML namespace
 * - provides all inherited from the `HTMLElement` DOM interfaces
    ...
    set children(children) {
        if(isArray(children)) {
            ...
            const child = typeof children === 'string'?
                ...
                children instanceof HTMLAssembler?
                    children.element :
                    children;
...
Object.defineProperty(HTMLAssembler.prototype, 'node', { writable : true, value : null });
