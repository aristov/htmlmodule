 ...
 */
export class HTMLSource extends HTMLElementAssembler {
    /**
     * @param {string} src
     */
    set src(src) {
    ...
    /**
     * @returns {interface} HTMLSourceElement
     * @override
     */
    static get interface() {
        return HTMLSourceElement || super.interface
    }
}
