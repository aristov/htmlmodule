...
import { HTMLDOMAssembler } from './assembler';
...
export function a(init) {
 // todo @param {String} [init.ping] URLs to ping
 // todo @param {String} [init.download] Whether to download the resource instead of navigating to it, and its file name if so
 // todo @param {String} [init.referrerPolicy] Determines the referrer policy for fetches initiated by the element
 ...
 * allows authors to specify the document base URL for the purposes of parsing URLs, and the name of the default browsing context for the purposes of following hyperlinks. The element does not represent any content beyond this information.
 *
...
export function body(init) {
 // todo @param {Function} [init.onhashchange] Fired at the Window when the fragment part of the document's URL changes
 // todo @param {Function} [init.onmessage] Fired at an object when it receives a message
 // todo @param {Function} [init.onstorage] Fired at Window event when the corresponding localStorage or sessionStorage storage areas change
...
export function embed(init) {
 // todo @param {String} [init.type] Type of embedded resource
...
export function iframe(init) {
 // todo @param {String} [init.srcdoc] A document to render in the iframe
 // todo @param {Boolean} [init.allowFullScreen] Whether to allow the iframe's contents to use requestFullscreen()
 // todo @param {String} [init.referrerPolicy] Determines the referrer policy for fetches initiated by the element
...
export function img(init) {
 // todo @param {String} [init.srcset] Images to use in different situations (e.g. high-resolution displays, small monitors, etc)
 // todo @param {String} [init.sizes] Image sizes for different page layouts
 // todo @param {String} [init.referrerPolicy] Determines the referrer policy for fetches initiated by the element
 ...
 * @param {String} [init.media] Applicable media* @param {String} [init.nonce] Cryptographic nonce used in [Content Security Policy](https://html.spec.whatwg.org/#refsCSP) checks
 * @param {String} [init.hreflang] Language of the linked resource
 * @param {String} [init.type] Hint for the type of the referenced resource
...
export function link(init) {
 // todo @param {String} [init.crossOrigin] How the element handles crossorigin requests
 // todo @param {String} [init.sizes] Sizes of the icons (for `rel="icon"`)
 // todo @param {String} [init.as] Destination for a preload request (for `rel="preload"`)
 ...
 * @param {String} [init.value]
 * @param {String} [init.defaultValue]
 * @param {String} [init.attrset.form] Associates the control with a form element
...
export function video(init) {
 // todo @param {String} [init.crossOrigin] How the element handles crossorigin requests
 // todo @param {Boolean} [init.playsInline] Encourage the user agent to display video content within the element's playback area
