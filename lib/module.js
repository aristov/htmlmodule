...
export class Slot extends HTMLElementAssembler {}
...
export class Svg extends HTMLElementAssembler {}
...
export const a = A.factory
export const abbr = Abbr.factory
export const span = Span.factory
export const colGroup = ColGroup.factory
export const object = HTMLObject.factory
export const variable = Var.factory
